...
class Orchestrator():
    ...
    def _get_angouleme_s_news(self):
        self._scrapper.get_news()
        
    def daily_publish(self):
        # articles_of_the_day: list[DBArticle]= self._db.get_article_by_date(datetime.now())
        ...
        print(dall_e_url.data[0].url)
        
    # def daily_routine(self):
    #     schedule.every(10).minutes.do(self._get_angouleme_s_news)
    #     schedule.every().day.at("9:00").do(self._daily_publish)
